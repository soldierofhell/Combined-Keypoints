...
__C.TEST.FORCE_JSON_DATASET_EVAL = True#False
...
# Indicates the model makes graph keypoint predictions (as in Mask R-CNN for
# graph keypoints)
__C.MODEL.GRAPH_KEYPOINTS_ON = False

# Indicates the model makes graph 3D keypoint predictions (as in Mask R-CNN for
# 3D graph keypoints)
__C.MODEL.GRAPH_3D_KEYPOINTS_ON = False
