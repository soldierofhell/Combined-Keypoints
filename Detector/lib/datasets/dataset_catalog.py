...
DATASETS = {
    ...
    'keypoints_carfusion': {
        IM_DIR:
            _DATA_DIR + '/train/',
        ANN_FN:
            _DATA_DIR + '/train/car_carfusion.json'
    },
    'keypoints_carfusion_coco': {
        IM_DIR:
            _DATA_DIR + '/train/',
        ANN_FN:
            _DATA_DIR + '/train/car_carfusion_coco.json'
    },
    ...
    'keypoints_carfusion_butler': {
        IM_DIR:
            _DATA_DIR + '/train/',
        ANN_FN:
            _DATA_DIR + '/train/car_butler.json'
    },
    'keypoints_carfusion_morewood': {
        IM_DIR:
            _DATA_DIR + '/train/',
        ANN_FN:
            _DATA_DIR + '/train/car_morewood.json'
    },
    'keypoints_carfusion_craig': {
        IM_DIR:
            _DATA_DIR + '/train/',
        ANN_FN:
            _DATA_DIR + '/train/car_craig.json'
    },
    'keypoints_carfusion_penn': {
        IM_DIR:
            _DATA_DIR + '/test/',
        ANN_FN:
            _DATA_DIR + '/test/car_penn.json'
    },
